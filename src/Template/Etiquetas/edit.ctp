...
<div class="ypunto-content etiquetas edit">
    <header class="ypunto-content-header">
        <h1 class="ypunto-title"><?= __('Editar Etiqueta') ?></h1>
    ...
    <?= $this->Form->create($etiqueta, ['class' => 'ypunto-form']) ?>

    <section class="ypunto-form-main">
        <fieldset>
            <?= $this->Form->control('nombre') ?>
            <?= $this->Form->control('entidades._ids', ['options' => $entidades]) ?>
        </fieldset>
    </section>
        ...
        <div class="card ypunto-actions-card">
            <div class="card-body bg-light">
                <ul class="list-unstyled text-muted small mb-0">
                    ...
                    <li><i class="far fa-fw fa-calendar-plus"></i> <?= __('Alta') ?> <strong><?= $etiqueta->created ?></strong></li>
                    <li><i class="far fa-fw fa-calendar-check"></i> <?= __('Modificado') ?> <strong><?= $etiqueta->modified ?></strong></li>
